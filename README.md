...
prism-ops-schedule-guard is a JavaScript project for automation. It focuses on this technical goal: Develop a JavaScript command-oriented project for schedule scenarios with log and snapshot fixtures, replay consistency checks, and single-node deterministic mode.
