...
$repo = "prism-ops-schedule-guard"
$language = "JavaScript"
$category = "Automation"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/prism-ops-schedule-walkthrough.md")) {
...
if ($hold -ne 2) { throw "$repo hold lane count changed" }
